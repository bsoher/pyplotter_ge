...
# Our modules
import pyplotter_ge.common.configobj as configobj
import pyplotter_ge.common.misc as util_misc
import pyplotter_ge.common.default_ini_file_content as default_ini_file_content

def get_last_export_path():
    """A shortcut for the Config object method of the same name."""
    config = PyPlotterGeConfig()
...
class BaseConfig(configobj.ConfigObj):
    ...
    There's subclasses of this class for reading specific PyPlotterGeConfig INI files,
    such as the PyPlotterGeConfig class. Each subclass first reads the default
...
class PyPlotterGeConfig(BaseConfig):
    def __init__(self):
        BaseConfig.__init__(self, "pyplotter_ge.ini")
